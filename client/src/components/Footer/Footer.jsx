      ...
      <div className="d-flex flex-row justify-content-between">
        <div className="d-flex flex-row col-6">
          ...
          <span className="col-12">
            <i className="fa-solid fa-house mx-2"></i>Address of the Store
          </span>
          <span className="col-12">
            <i className="fa-solid fa-phone mx-2"></i>Telephone: +1 555 555 55
          </span>
          <span className="col-12">
            <i className="fa-solid fa-envelope mx-2"></i>Email: email@gmail.com
          </span>
          <span className="col-12">
            <i className="fa-solid fa-clock mx-2"></i>8:00-19:00,
            Monday-Saturday
          </span>
        </div>
        <div className="d-flex flex-row col-6  ">
